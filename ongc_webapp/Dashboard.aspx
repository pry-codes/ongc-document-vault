<%@ Page Title="System Dashboard" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="ongc_webapp.Dashboard" %><asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-8">
                <div class="chart-card">
                    <div class="chart-title">Document Indexing Trends</div>
            ...
            <div class="col-md-4">
                <div class="chart-card">
                    ...
                    <canvas id="fileTypePieChart"></canvas>
                </div>
            </div>
        </div>
    ...
    <footer class="footer-tech text-center">
        <div class="container">
            <p class="mb-1">&copy; 2026 Oil and Natural Gas Corporation Limited. All Rights Reserved.</p>
            <small>Internal Enterprise System | Authorized Personnel Only</small>
        </div>
    </footer>
...
new Chart(document.getElementById('indexingChart'), {
    ...
    options: {
        ...
        scales: {
            x: { title: { display: true, text: 'Timeline (Month)', font: { weight: 'bold' } } },
            y: { title: { display: true, text: 'Documents Indexed', font: { weight: 'bold' } }, beginAtZero: true }
        }
    }
});
